...
def _status_lint(folder, meta, tracks, past=False):
    ...
    gh = "https://github.com/Prompt-Engineering-Conference/%s/blob/main/%s/" % (_LINT_REPO, folder)   # PEC lives in its own GitHub org
...
print(DIVIDER)
_site_root = next((u.replace("status/", "") for b, u, c in _STATUS_BRANDS if b.lower() == _me.lower()), "https://promptengineering.rocks/")
